      ...
      <section className={utilStyles.headingMd}>
        <div className={styles.content}>
          <div className={styles.left}>
            ...
            <p><i className="fa-solid fa-file"></i> <Link href="https://j-blewitt.notion.site/Joshua-Blewitt-Resume-CV-accea10012824431bc7f8654d77590a2?pvs=4" rel="noopener noreferrer" target="_blank">Online Resume/CV</Link></p>
